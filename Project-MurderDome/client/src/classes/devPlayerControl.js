...
const Actions_js_1 = require("../../../shared/src/classes/Actions.js");
const Player_js_1 = require("../../../shared/src/classes/Player.js");
class PlayerControl {
    constructor(parentElement, id, allPlayerIds) {
        ...
        this.player = new Player_js_1.Player(this.playerId, this.getName(), this.getStats());
    ...
    _populateVitalsElements() {
        ...
        this._hpElement.value = Player_js_1.Player.STARTINGVITALS.hp + "";
        this._sanElement.value = Player_js_1.Player.STARTINGVITALS.san + "";
        this._staElement.value = Player_js_1.Player.STARTINGVITALS.sta + "";
    }
    _populateStatElements() {
        ...
        this._strElement.value = Player_js_1.Player.DEFAULTSTATS.str + "";
        this._dexElement.value = Player_js_1.Player.DEFAULTSTATS.dex + "";
        this._conElement.value = Player_js_1.Player.DEFAULTSTATS.con + "";
        this._intElement.value = Player_js_1.Player.DEFAULTSTATS.int + "";
        this._wisElement.value = Player_js_1.Player.DEFAULTSTATS.wis + "";
        this._chaElement.value = Player_js_1.Player.DEFAULTSTATS.cha + "";
    }
    _populateActionMod() {
        this._actionModElement = this._createNumberInput(this.actionModLabel);
        this._actionModElement.value = Player_js_1.Player.DEFAULTMODIFIER + "";
    }
    _populateActionElement() {
        this._actionSelectElement = this._createSelect(this.actionSelectLabel, Object.keys(Actions_js_1.Action.PLAYERACTIONS));
    }
    ...
    updatePlayerAction() {
        ...
        if (this._actionSelectElement.selectedIndex != -1 && this._actionSelectElement.options.length > 0) {
            ...
            if (Actions_js_1.Action.isValidAction(selectedOption.value)) {
